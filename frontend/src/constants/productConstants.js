...
export const PRODUCT_REVIEW_REQUEST = 'PRODUCT_UPDATE_REVIEW_REQUEST'
export const PRODUCT_REVIEW_SUCCESS = 'PRODUCT_UPDATE_REVIEW_SUCCESS'
export const PRODUCT_REVIEW_FAIL = 'PRODUCT_UPDATE_REVIEW_FAIL'
export const PRODUCT_REVIEW_RESET = 'PRODUCT_UPDATE_REVIEW_RESET'

export const PRODUCT_QUANTITY_REQUEST = 'PRODUCT_QUANTITY_REQUEST'
export const PRODUCT_QUANTITY_SUCCESS = 'PRODUCT_QUANTITY_SUCCESS'
export const PRODUCT_QUANTITY_FAIL = 'PRODUCT_QUANTITY_FAIL'
